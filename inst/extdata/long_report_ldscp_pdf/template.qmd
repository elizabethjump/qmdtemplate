...
subtitle: Subtitle with additional info goes here. it will wrap if needed
program: Program or project name here
timeframe: March 2024
department: Department name
author: Author 1 (Name, degree and position), Author 2 (Name, degree and position), Author 3 (Name, degree and position), etc
format:
  long_report_ldscp_pdf-typst: default
toc: true
execute:
  echo: false
  eval: true
...
:::{#secondcol}
![](plot_jitter.png){fig-align="center" width=3in}
:::
::::
